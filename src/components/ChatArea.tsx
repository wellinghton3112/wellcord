    ...
    return (
      <div key={`poll-${poll.id}`} id={`poll-${poll.id}`} className="my-1 ml-14 mr-2 max-w-md rounded-lg bg-[var(--surface)] p-2.5 scroll-mt-20">
        ...
        <div className="mt-1 flex items-center gap-2">
          <span className="text-[11px] text-zinc-400">{total} voto{total === 1 ? "" : "s"}</span>
    ...
    >
      ...
      {viewMode === "dm" ? (
            ...
            {!selectedDM ? (
              <div className="h-full flex flex-col items-center justify-center text-zinc-400 gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-zinc-400 mt-1">Escolha uma DM ou inicie uma nova</p>
                </div>
              </div>
            ) : dmMessages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-zinc-400 gap-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-zinc-400 mt-1">Início da conversa</p>
                </div>
              </div>
            ) : (
              dmMessages.map((m) => (
        ...
        <>
          ...
          >
            {loadingOlder && <p className="text-center text-xs text-zinc-400 py-2">Carregando mais...</p>}
