    ...
    if (this.state.hasError) {
      return this.props.fallback || (
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
          <div className="bg-surface rounded-lg p-8 max-w-md w-full text-center shadow-2xl">
            ...
            <button
              ...
              className="px-6 py-2 bg-accent hover:bg-accent-hover rounded text-sm font-medium text-white"
            >
              Recarregar
            </button>
          </div>
